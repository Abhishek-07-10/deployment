package com.emplyeemanagement.employeemanagement.configuration;
...
public class Config {
    ...
    public UserDetailsService userDeatails(PasswordEncoder encoder) {
        UserDetails admin = User.withUsername("admin").password(encoder.encode("abhi321")).roles("ADMIN").build();
